...
export default function HeroNavbar() {
  return (
    <motion.div
      ...
      className="flex items-end justify-between py-2 px-2 w-[95%] md:w-[80%] z-10  mx-auto  sticky top-0 bg-black/70 rounded-md"
    >
      ...
      <div className="flex gap-10">
        ...
        <div className="flex gap-3">
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            transition={{ duration: 0.3 }}
            className=" px-2 py-0.5 cursor-pointer  rounded-md font-bold text-sm   border border-green-700 text-white"
          >
            Sign up
          </motion.button>
        </div>
